...
writedlm( "/results/allsolutions.csv",  sol, ',')
sz=size(sol)
...
writedlm( "/results/stablesolutions.csv",  sol[stblindx[1:stblcntindx-1]], ',')
...
file = open("/results/CAREresults.txt", "w")
...
println(file,"\n\n P1 -- ", sP1, "\n\n P2 -- ", sP2, "\n\n P3 --", sP3)
println(file,"\n Stabilizing solutions are written in the file stablesolutions.csv\n")
